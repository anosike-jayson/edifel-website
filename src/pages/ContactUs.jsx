      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-stretch justify-between rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="relative w-full lg:w-1/2 flex items-center">
          <img
            src={img}
            alt="Contact Us"
            className="w-full h-full object-cover rounded-l-lg transition-transform duration-300 transform hover:scale-105"
          />
          <div className="absolute bottom-6 left-6 flex justify-start space-x-4">
            <a href="your-linkedin-link" target="_blank" rel="noopener noreferrer" className="text-white hover:text-green-500 transition-colors duration-300">
              <FaLinkedin className="w-8 h-8 hover:scale-110 transition-transform duration-300" />
            </a>
            <a href="your-telegram-link" target="_blank" rel="noopener noreferrer" className="text-white hover:text-green-500 transition-colors duration-300">
              <FaTelegramPlane className="w-8 h-8 hover:scale-110 transition-transform duration-300" />
            </a>
            <a href="your-facebook-link" target="_blank" rel="noopener noreferrer" className="text-white hover:text-green-500 transition-colors duration-300">
        ...
        <div className="flex-grow w-full lg:w-1/2 p-8 bg-white">
          ...
          <p className="mb-8 text-gray-600">We are here to answer your questions and address your concerns, 24/7.</p>
          <form ref={formRef} onSubmit={sendEmail} className="space-y-6 max-w-md">
            <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
              <div className="relative w-full lg:w-1/2">
                ...
                <input
                  ...
                  name="firstName"  // Match with {{firstName}} in template
                  required
              ...
              <div className="relative w-full lg:w-1/2">
                ...
                <input
                  ...
                  name="lastName"  // Match with {{lastName}} in template
                  required
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-200"
                />
              </div>
            ...
            <div className="relative">
              ...
              <input
                type="email"
                placeholder="Email"
                name="email"  // Match with {{email}} in template
                required
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-200"
              />
            </div>
            <div className="relative">
              ...
              <input
                ...
                name="phone"  // Match with {{phone}} in template
                required
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-200"
              />
            </div>
            <textarea
              ...
              name="message"  // Match with {{message}} in template
              required
